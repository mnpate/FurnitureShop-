<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeFile="chandelier.aspx.cs" Inherits="User_Default" %>
    ...
    <br><br><br><br><br>
     <div class="heading_container heading_center">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FurnitureShop-1ConnectionString %>" SelectCommand="SELECT * FROM [Products] WHERE ([Subcname] = @Subcname)">
            <SelectParameters>
                <asp:Parameter DefaultValue="chandelier" Name="Subcname" Type="String"></asp:Parameter>
            </SelectParameters>
        </asp:SqlDataSource>
        <br /><br />
    </form>
