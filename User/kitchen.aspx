<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeFile="kitchen.aspx.cs" Inherits="User_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  padding: 15px 25px;
	...
	<div class="row">
        ...
        <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString1 %>" SelectCommand="SELECT * FROM [product] WHERE ([subcname] = @subcname)">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FurnitureShop-1ConnectionString %>" SelectCommand="SELECT * FROM [Products] WHERE ([Subcname] = @Subcname)">
            <SelectParameters>
                <asp:Parameter DefaultValue="kitchen" Name="Subcname" Type="String"></asp:Parameter>
            </SelectParameters>
        </asp:SqlDataSource>
    <br /><br />
